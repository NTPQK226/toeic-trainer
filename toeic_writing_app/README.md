# TOEIC Writing Trainer — Part 1 & Part 2 (Chuẩn ETS)

Ứng dụng web tĩnh (không cần server) luyện thi & chấm điểm **TOEIC Writing**:

- **Part 1 — Mô Tả Tranh:** **155 câu** (Bộ 100 câu cơ bản + **Bộ đề SEC 55 câu mới**). Thi thử 5 câu / 8 phút, chấm thang **0–3**.
- **Part 2 — Viết Email:** **50 đề** chuẩn khảo thí (Q6 & Q7), giao diện email client thực tế. Thi thử 2 câu / 20 phút, chấm thang **0–4**.
...
- Vào thư mục `toeic_writing_app/` → nhấp đúp **`index.html`** (hoặc `part2/index.html` cho Part 2).
...
### Part 2 — Viết Email (0–4 điểm)
- **50 đề** theo 8 chủ đề (Invitation, Inquiry, Complaint, Booking, Job, Service, Welcome, Feedback) + Bộ SEC.
...
- **Sáng / Tối:** đồng bộ giữa Part 1 & Part 2 (mặc định sáng).
...
```
toeic_writing_app/
├── index.html            # Part 1 — mô tả tranh (155 câu)
...
└── part2/
    ├── index.html        # Part 2 — viết email (50 đề)
