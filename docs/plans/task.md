# Nhiệm vụ Triển Khai: Bộ Đề SEC (55 Câu Mới), Sửa Dark Mode & Chuẩn Hóa Icon

| STT | Nhiệm vụ | Trạng thái | Ghi chú |
|---|---|---|---|
| 1 | Pipeline trích xuất ảnh, crop sạch sẽ & biên soạn 55 câu bộ đề SEC | Đã hoàn thành | 155 câu hỏi đầy đủ, 55 ảnh q101.jpg-q155.jpg đã crop sạch |
| 2 | Sửa triệt để lỗi màu sắc tương phản Dark Mode (nền vàng chữ trắng) | Đã hoàn thành | Đã sửa biến màu --accent-light, --warning-light, .grammar-tip-box, .score-2 |
